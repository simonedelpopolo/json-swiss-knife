 ...
 * @type {symbol}
 */
export const property_valueSymbol = Symbol( 'The function property_value(array):string|object' )
export const property_value = Object.defineProperty( json_swiss_knife, property_valueSymbol, {
    enumerable: true,
    configurable: false,
    writable: false,
    ...
    value: async function property_value( array, obj = false ) {
        ...
        let is_array
        is_array = await jsn__.array( array ).catch( error => error )
...
// Freeze the json_swiss_knife Object Module
